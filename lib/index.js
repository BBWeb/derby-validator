...
Validator.prototype.getValues = function () {
  ...
  function get(collection, segments, fieldsObject, values) {
    _.each(collection, function (field, fieldName) {
      ...
      get(field, newSegments, fieldsObject[fieldName], values[fieldName]);
    });
  }
...
Validator.prototype._getFieldsObject = function () {
  ...
  _.each(this.fields, function (field, fieldName) {
    ...
    while(segments.length > 1) {
      ...
      fieldsObject[segment] = {};
    }

    fieldsObject[segments[0]] = true;
  });
...
Validator.prototype._addFromOrigin = function () {
  ...
  add(this.origin.get(), [], fieldsObject);
};
